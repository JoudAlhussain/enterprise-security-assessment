...
A `quarantine` subfolder was also discovered containing files with malware-suggestive names (e.g. `juicy\_malware\_windows\_64.exe.url`). In line with safe testing practice, these files were identified and logged but not opened, downloaded, or executed.
